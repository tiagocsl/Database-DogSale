CREATE DATABASE  IF NOT EXISTS `dogsale` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dogsale`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: dogsale
-- ------------------------------------------------------
...
--
-- Dumping events for database 'dogsale'
--

--
-- Dumping routines for database 'dogsale'
--
...
-- Dump completed on 2020-05-04 21:00:20
